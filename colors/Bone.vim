...
" Author:  Ramzi Akremi, customed by barret
" License: MIT
" Version: 1.1.2
...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  call <sid>X('StatusLine',   s:syntax_cursor,     s:hue_2,  'none')
...
" Public API --------------------------------------------------------------{{{
function! Bone#highlight(group, fg, bg, attr)
